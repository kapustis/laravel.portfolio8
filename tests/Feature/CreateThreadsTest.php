...
class CreateThreadsTest extends TestCase
{
    ...
    protected function publishThread($overrides = [])
    {
        ...
        $thread = make('App\Models\BlogThread', $overrides);
    ...
    function test_authenticated_users_must_first_confirm_their_email_address_before_creating_threads()
    {
        ...
        $this->signIn($user);
        $thread = make('App\Models\BlogThread');
    ...
    {
        BlogChannel::factory()->count(2)->create();
    ...
    {
        $this->signIn();
        $thread = create('App\Models\BlogThread', ['title' => 'Help Me']);
        $this->assertEquals('help-me', $thread->slug);
        $thread2 = create('App\Models\BlogThread', ['title' => 'Help Me']);
    ...
    {
        $this->signIn();
        create('App\Models\BlogThread', ['title' => 'Help 13']);
        $thread2 = create('App\Models\BlogThread', ['title' => 'Help 13']);
    ...
    function test_authorized_users_can_delete_threads()
    {
        ...
        $reply = create('App\Models\BlogReply', ['thread_id' => $thread->id]);
